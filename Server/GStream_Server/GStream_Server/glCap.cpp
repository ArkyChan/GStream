...
bool glCap::LoadTGAFile(char *file)
{
	if(textureExist)
		FreeImage();
...
bool glCap::WriteTGA(char *file, short int width, short int height, unsigned char *outImage)
{
...
void glCap::SaveTGAScreenShot(char *filename, int w, int h)
{
